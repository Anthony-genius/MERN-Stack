...
import SdgTab from './SdgTab'
import SdgChallenge from './SdgChallenge'
import SdgFocuses from './SdgFocuses'
import TabsAlertDialog from './TabsAlertDialog'
      ...
      <>
        ...
        <Grid container spacing={3} className={classes.tabsContainer}>
          <Grid item xs={12} sm={2}>
            ...
            {editMode && (
              <div className={classes.editSdgs} onClick={this.toggleEdit}>
                {!open ? (
                  <ButtonBase className={classes.button}>
                    <Typography>Edit Sdgs</Typography>
                    <EditIcon />
                  </ButtonBase>
                ) : (
                  <ButtonBase className={classes.button}>
                    <Typography>Close Sdgs</Typography>
                    <CloseIcon />
                  </ButtonBase>
                )}
              </div>
            ...
            <h4
              className={editMode ? classes.relevanceEdit : classes.relevance}
            >
              Why it matters
            </h4>
          </Grid>
        ...
        {editMode && open && (
          <Grid item xs={12}>
            <RecommendationsSdgs dashboardMode updateMember={updateMember} />
            <div className={classes.closeSdgs} onClick={this.toggleEdit}>
              <ButtonBase className={classes.button}>
                <Typography>Close Sdgs</Typography>
                <CloseIcon />
              </ButtonBase>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={2}>
            <h4 className={classes.leftTitle}>The Challenge</h4>
          </Grid>
        ...
        <Grid container spacing={3} className={classes.focusContainer}>
          <Grid item xs={12} sm={2}>
            ...
            {editMode && (
              <div
                className={classes.editOpportunities}
                onClick={
                  !editOpportunities
                    ? this.toggleEditOpportunities
                    : this.saveFocuses
              ...
              >
                {!editOpportunities ? (
                  <ButtonBase className={classes.button}>
                    <Typography>Edit Areas</Typography>
                    <EditIcon />
                  </ButtonBase>
                ) : (
                  <ButtonBase className={classes.button}>
                    <Typography>Close Areas</Typography>
                    <CloseIcon />
                  </ButtonBase>
                )}
              </div>
