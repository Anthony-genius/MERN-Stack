  ...
  return (
    <React.Fragment>
      <div className={style.bodyContainer}>
        <h2>Welcome to Impacti, LLC and Impacti SAS</h2>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of Impacti, LLC and Impacti SAS's Website.
        </p>{' '}
        <br />
        <span className={style.capitalizeTitle}>
          {' '}
          Impacti, LLC and Impacti SAS
        </span>{' '}
        is located at:
        <br />
        <p>
          39 Westchester Avenue <br /> Pound Ridge, NY 10576
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions in full. Do not continue to use Impacti, LLC and Impacti
          SAS's website if you do not accept all of the terms and conditions
          stated on this page.
        </p>
        <p>
        ...
        <h2>Cookies</h2>
        <p>
          We employ the use of cookies. By using Impacti, LLC and Impacti SAS's
          website you consent to the use of cookies in accordance with Impacti,
          LLC and Impacti SAS’s privacy policy.
        </p>
        <p>
        ...
        <h2>License</h2>
        <p>
          Unless otherwise stated, Impacti, LLC and Impacti SAS and/or it’s
          licensors own the intellectual property rights for all material on
          Impacti, LLC and Impacti SAS. All intellectual property rights are
          reserved. You may view and/or print pages from
          https://impacti.solutions for your own personal use subject to
        ...
        <ol>
          <li>
            ...
            <a href="https://impacti.solutions">https://impacti.solutions</a>
          </li>
          <li>
        ...
        <p>
          Redistribute content from Impacti, LLC and Impacti SAS (unless content
        ...
        <ol>
          ...
          <li>
            ...
            ('Comments') in areas of the website. Impacti, LLC and Impacti SAS
            ...
            opinions of Impacti, LLC and Impacti SAS, its agents or affiliates.
            Comments reflect the view and opinion of the person who posts such
            view or opinion. To the extent permitted by applicable laws Impacti,
            LLC and Impacti SAS shall not be responsible or liable for the
          ...
          <li>
            Impacti, LLC and Impacti SAS reserves the right to monitor all
          ...
          <li>
            You hereby grant to <strong>Impacti, LLC and Impacti SAS</strong> a
        ...
        <p>
          ...
          outweighs the absence of Impacti, LLC and Impacti SAS; and (d) where
        ...
        <p>
          ...
          e-mail to{' '}
          <a
            href="mailto:discover@impacti.solutions"
            title="send an email to discover@impacti.solutions"
          >
        ...
        <p>
          No use of Impacti, LLC and Impacti SAS’s logo or other artwork will be
